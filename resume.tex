...
% \photo[rectangle,noedge,right]{./Resume Photo.png}
\name{Garvit}{Sukhija}
% \position{Software Architect{\enskip\cdotp\enskip}Security Expert}
% \address{Flat 14, 1st Floor, Harsh Enclave, Huda 19, Kaithal, Hr.}

\mobile{+91-7508883655}
\email{garvit.sukh@gmail.com}
% \dateofbirth{January 1st, 1970}
% \photo[rectangle,noedge,right]{Resume Photo.png}
%\homepage{www.posquit0.com} 
% \github{github.com/themagicalmammal}
\linkedin{linkedin.com/in/garvitsukhija/}
% \gitlab{gitlab-id}
